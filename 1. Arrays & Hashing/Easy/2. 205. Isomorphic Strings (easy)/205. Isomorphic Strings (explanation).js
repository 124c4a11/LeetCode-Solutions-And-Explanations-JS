...
function isIsomorphic(s, t) {
  ...
  // Выполняем проверку на неравенство длин двух
  // входных строк s и t.
  //
  // Если длины различаются, сразу прекращает
  // выполнение функции и возвращает логическое
  // false.
  //
  // Строки разной длины не могут быть изоморфными
