...
function permuteUnique(nums) {
  ...
  !function dfs() {
    ...
    // 1   | dfs depth 0, i = 0                        | [1]       | [true, false, false]    | []
    // 2   | dfs depth 1, i = 0 — пропускаем (дубликат)| [1]       | [true, false, false]    | []
    // 3   | dfs depth 1, i = 1                        | [1,1]     | [true, true, false]     | []
    // 4   | dfs depth 2, i = 0 — пропускаем (дубликат)| [1,1]     | [true, true, false]     | []
    // 5   | dfs depth 2, i = 1 — пропускаем (дубликат)| [1,1]     | [true, true, false]     | []
    // 6   | dfs depth 2, i = 2                        | [1,1,2]   | [true, true, true]      | []
    // 7   | dfs depth 3 базовый случай, добавляем     | [1,1,2]   | [true, true, true]      | [[1,1,2]]
    // 8   | откатываем до depth 2, i = 2              | [1,1,2]   | [true, true, true]      | [[1,1,2]]
    // 9   | откат последнего шага (pop и visit=false) | [1,1]     | [true, true, false]     | [[1,1,2]]
    // 10  | dfs depth 2, i = 3 - завершаем dfs 2      | [1,1]     | [true, true, false]     | [[1,1,2]]
    // 11  | откатываем до depth 1, i = 1              | [1,1]     | [true, true, false]     | [[1,1,2]]
    // 12  | откат последнего шага (pop и visit=false) | [1]       | [true, false, false]    | [[1,1,2]]
    // 13  | dfs depth 1, i = 2                        | [1,2]     | [true, false, true]     | [[1,1,2]]
    // 14  | dfs depth 2, i = 0 — пропускаем (дубликат)| [1,2]     | [true, false, true]     | [[1,1,2]]
    // 15  | dfs depth 2, i = 1                        | [1,2,1]   | [true, true, true]      | [[1,1,2]]
    // 16  | dfs depth 3 базовый случай, добавляем     | [1,2,1]   | [true, true, true]      | [[1,1,2], [1,2,1]]
    // 17  | откатываем до depth 2, i = 1              | [1,2,1]   | [true, true, true]      | [[1,1,2], [1,2,1]]
    // 18  | откат последнего шага (pop и visit=false) | [1,2]     | [true, false, true]     | [[1,1,2], [1,2,1]]
    // 19  | dfs depth 2, i = 1                        | [1,2]     | [true, false, true]     | [[1,1,2], [1,2,1]]
    // 20  | dfs depth 2, i = 2 — пропускаем (дубликат)| [1,2]     | [true, false, true]     | [[1,1,2], [1,2,1]]
    // 21  | dfs depth 2, i = 3 — завершаем dfs 2      | [1,2]     | [true, false, true]     | [[1,1,2], [1,2,1]]
    // 22  | откатываем до depth 1, i = 2              | [1,2]     | [true, false, true]     | [[1,1,2], [1,2,1]]
    // 23  | откат последнего шага (pop и visit=false) | [1]       | [true, false, false]    | [[1,1,2], [1,2,1]]
    // 24  | dfs depth 1, i = 3 — завершаем dfs 1      | [1]       | [true, false, false]    | [[1,1,2], [1,2,1]]
    // 25  | откатываем до depth 0, i = 0              | [1]       | [true, false, false]    | [[1,1,2], [1,2,1]]
    // 26  | откат последнего шага (pop и visit=false) | []        | [false, false, false]   | [[1,1,2], [1,2,1]]
    // 27  | dfs depth 0, i = 1 — пропускаем (дубликат)| []        | [false, false, false]   | [[1,1,2], [1,2,1]]
    // 28  | dfs depth 0, i = 2                        | [2]       | [false, false, true]    | [[1,1,2], [1,2,1]]
    // 29  | dfs depth 1, i = 0                        | [2,1]     | [true, false, true]     | [[1,1,2], [1,2,1]]
    // 30  | dfs depth 2, i = 0 — пропускаем (дубликат)| [2,1]     | [true, false, true]     | [[1,1,2], [1,2,1]]
    // 31  | dfs depth 2, i = 1                        | [2,1,1]   | [true, true, true]      | [[1,1,2], [1,2,1]]
    // 32  | базовый случай, добавляем                 | [2,1,1]   | [true, true, true]      | [[1,1,2], [1,2,1], [2,1,1]]
    // 33  | финальный откат, готово результатом       | []        | [false, false, false]   | [[1,1,2], [1,2,1], [2,1,1]]
  }();
