...
function postorderTraversal(root) {
  ...
  while (curr || stack.length) {
    ...
    if (curr) {
      ...
      // Откладываем левый потомок в стек,
    ...
    // в конец правого пути.
    //
    // Достаем из стека следующий узел
    // (левый потомок предыдущих узлов)
    //
    // В нашем примере здесь извлекается Node(2)
    //
    // После первого pop: curr = null, stack = [Node(2)]
    // После второго pop: curr = Node(2), stack = []
    curr = stack.pop();
  }
